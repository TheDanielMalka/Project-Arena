...
const SEED_MATCHES: Match[] = [
  ...
  { id: "h1",  type: "public", host: "user-001",    hostId: "user-001", game: "CS2",          mode: "1v1", betAmount: 50,  players: ["user-001", "ShadowKill3r"], maxPlayers: 2, status: "completed",   winnerId: "user-001", createdAt: "2026-03-25T09:00:00", endedAt: "2026-03-25T09:45:00", teamA: ["user-001"],    teamB: ["ShadowKill3r"], maxPerTeam: 1 },
