...
const SEED_MATCHES: Match[] = [
  ...
  // c5: PUBG 4v4 kept as infrastructure mock — PUBG shown as Coming Soon in UI until Client supports it
  ...
  // h3 was Fortnite, h5/h10 were Apex Legends → changed to CS2/Valorant (mock data only, DB will have real history)
  ...
  { id: "h3",  type: "public", host: "user-001",    hostId: "user-001", game: "CS2",      mode: "1v1", betAmount: 10,  players: ["user-001", "BlazeFury"],    maxPlayers: 2, status: "completed",   winnerId: "user-001", createdAt: "2026-03-24T14:00:00", endedAt: "2026-03-24T14:30:00", teamA: ["user-001"],    teamB: ["BlazeFury"],   maxPerTeam: 1 },
  ...
  { id: "h5",  type: "public", host: "user-001",    hostId: "user-001", game: "Valorant", mode: "1v1", betAmount: 30,  players: ["user-001", "CyberWolf"],    maxPlayers: 2, status: "completed",   winnerId: "user-001", createdAt: "2026-03-23T20:00:00", endedAt: "2026-03-23T21:00:00", teamA: ["user-001"],    teamB: ["CyberWolf"],   maxPerTeam: 1 },
  ...
  { id: "h10", type: "public", host: "ProGamer99",  hostId: "u-pro",    game: "CS2",      mode: "1v1", betAmount: 40,  players: ["ProGamer99", "user-001"],   maxPlayers: 2, status: "completed",   winnerId: "u-pro",    createdAt: "2026-03-19T14:00:00", endedAt: "2026-03-19T15:00:00", teamA: ["ProGamer99"],  teamB: ["user-001"],    maxPerTeam: 1 },
